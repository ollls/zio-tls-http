...
>**Our new HTTP/2 server can talk HTTP/1.1 now!<br> Please, check it out. <br>Simplified, streamlined, massivley parallel with nothing but ZIO Streams and HTTP/2, for client and server.
